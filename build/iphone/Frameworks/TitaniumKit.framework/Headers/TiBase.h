...
// in simulator we redefine to format for sample_admob Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.sample_admob." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.sample_admob";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIsample_admobNativeItemNone = -1,
  UIsample_admobNativeItemSpinner = -2,
  UIsample_admobNativeItemProgressBar = -3,

  UIsample_admobNativeItemSlider = -4,
  UIsample_admobNativeItemSwitch = -5,
  UIsample_admobNativeItemMultiButton = -6,
  UIsample_admobNativeItemSegmented = -7,

  UIsample_admobNativeItemTextView = -8,
  UIsample_admobNativeItemTextField = -9,
  UIsample_admobNativeItemSearchBar = -10,

  UIsample_admobNativeItemPicker = -11,
  UIsample_admobNativeItemDatePicker = -12,

  UIsample_admobNativeItemInfoLight = -13,
  UIsample_admobNativeItemInfoDark = -14,

  UIsample_admobNativeItemDisclosure = -15,

  UIsample_admobNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all sample_admob instances of
