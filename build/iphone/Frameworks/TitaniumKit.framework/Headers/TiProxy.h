...
// Rare exceptions to indicate a bug in the _sample_admob code (Eg, function that a subclass should have implemented)
...
/**
 The base class for sample_admob proxies.
 */
