...
/**
 Base class for all sample_admob views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the sample_admob view hierarchy (such as wrapped iOS UIViews) was touched.
